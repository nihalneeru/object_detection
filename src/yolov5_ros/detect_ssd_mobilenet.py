...
from yolov5_ros.utils import load_ssd_mobilenet_model

class SSDMobilenetDetector:
    def __init__(self):
        rospy.init_node('ssd_mobilenet_detector', anonymous=True)

        self.model = load_ssd_mobilenet_model()
    ...
    def image_callback(self, msg):
        ...
        cv2.imshow("SSD Mobilenet Detections", np.squeeze(results.render()))
        cv2.waitKey(1)
