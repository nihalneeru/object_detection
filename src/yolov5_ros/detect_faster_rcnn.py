...
from yolov5_ros.utils import load_faster_rcnn_model

class FasterRCNNDetector:
    def __init__(self):
        rospy.init_node('faster_rcnn_detector', anonymous=True)
    ...
    def image_callback(self, msg):
        ...
        cv2.imshow("Faster R-CNN Detections", np.squeeze(results.render()))
        cv2.waitKey(1)
