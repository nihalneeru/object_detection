...
from yolov5_ros.utils import load_efficientdet_model

class EfficientDetDetector:
    def __init__(self):
        rospy.init_node('efficientdet_detector', anonymous=True)

        self.model = load_efficientdet_model()
    ...
    def image_callback(self, msg):
        ...
        cv2.imshow("EfficientDet Detections", np.squeeze(results.render()))
        cv2.waitKey(1)
